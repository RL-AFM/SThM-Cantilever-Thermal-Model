...
def plotPower(arr,plotref,log=False):
    ax=fdict[plotref]
...
def constructMetalDicts(padded_dict,current):
    ...
    for key,value in padded_dict.iteritems():
        if key=='Pd':
            ...
            print '----> The total electrical resistance of the Pd sensor is {0}Ω'.format(PdResistance)
...
#load the file
elements=get_elements_from_GDS('./gds generated for testing/CutoutTest.gds')
